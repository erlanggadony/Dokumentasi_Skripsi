...
\begin{figure}[H]
	\centering
		\includegraphics[scale=0.5]{F:/Skripsi/Template/Gambar/Diagram/sistem_terkini/organigram/organigram_fakultas.JPG}
...
\begin{figure}[H]
	\centering
		\includegraphics[scale=0.35]{F:/Skripsi/Template/Gambar/Diagram/sistem_terkini/work_flow/pemesanan_terkini.jpg}
...
\begin{figure}[H]
	\centering
		\includegraphics[scale = 0.35]{F:/Skripsi/Dokumentasi_Skripsi/Gambar/Diagram/sistem_usulan/flowchart/Flowchart0.png}
